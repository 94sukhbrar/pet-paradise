...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="<?= Url::toRoute(['/site/index']) ?>"><span class="flaticon-pawprint-1 mr-2"></span><?= Yii::$app->params['websiteName'] ?></a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
        <span class="fa fa-bars"></span> Menu
      </button>
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active"><a href="<?= Url::toRoute(['/site/index']) ?>" class="nav-link">Home</a></li>
          <li class="nav-item"><a href="<?= Url::toRoute(['/site/about']) ?>" class="nav-link">About</a></li>
          <li class="nav-item"><a href="vet.html" class="nav-link">Veterinarian</a></li>
          <li class="nav-item"><a href="<?= Url::toRoute(['/site/local-services']) ?>" class="nav-link">Local Services</a></li>
          <li class="nav-item"><a href="<?= Url::toRoute(['/site/adopt']) ?>" class="nav-link">Pet List</a></li>
          <li class="nav-item"><a href="pricing.html" class="nav-link">Pricing</a></li>
          <li class="nav-item"><a href="<?= Url::toRoute(['/site/feed']) ?>" class="nav-link">Blog</a></li>
          <li class="nav-item"><a href="<?= Url::toRoute(['/site/contact']) ?>" class="nav-link">Contact</a></li>
        </ul>
      </div>
    </div>
  </nav>
