...
<div class="mb-4">
    <div class="card post-card">
        ...
        <div class="card-body">
            ...
            <p class="card-text meta">By <strong><?= $model->getRelatedDataLink('created_by_id') ?>  </strong> • <span class="meta"><?= Yii::$app->formatter->asDate($model->created_on, 'php:d F Y'); ?></span></p>
