...
<div class="card mb-4">
  <div class="card-body">
    <h6 class="card-title">Our Promise</h6>
    <p class="mb-1 meta">We promise to treat every pet as our own, deliver quality services with honesty, and continuously work towards building a kinder, pet-friendly community.</p>
