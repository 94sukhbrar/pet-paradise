...
use app\models\search\Petcategory as PetcategorySearch;
 ...
 */
class PetcategoryController extends TController
{
	...
	public function actionAdd()
	{
		...
		$model->state_id = Petcategory::STATE_ACTIVE;
		...
		if ($model->load($post)) {
			...
			$model->saveUploadedFile($model, 'pet_icon');
			if($model->save()){
