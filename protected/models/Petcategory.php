...
/**
* This is the model class for table "tbl_pet_category".
*
    * @property integer $id
...
class Petcategory extends \app\components\TActiveRecord
{
    ...
    */
    ...
    {
    	return $this->hasMany(Pet::class, ['pet_category_id' => 'id']);
    }
    public static function getHasManyRelations()
    {
    	$relations = [];
		$relations['Pets'] = ['pets','Pet','id','pet_category_id'];
		return $relations;
	}
	...
	public function beforeDelete() {
		//Pet::deleteRelatedAll(['pet_category_id'=>$this->id]);
